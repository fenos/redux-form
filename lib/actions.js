...
var registerField = exports.registerField = function registerField(form, name, type, validate) {
  return { type: _actionTypes.REGISTER_FIELD, meta: { form: form }, payload: { name: name, type: type, validate: validate } };
};
