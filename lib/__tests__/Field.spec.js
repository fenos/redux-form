...
var describeField = function describeField(name, structure, combineReducers, expect) {
  ...
  it.only('allow to specify validation on the Field component', function () {
    var store = makeStore({
      testForm: {
        values: {
          username: 'redux-form'
    ...
    var validateFn = function validateFn(value) {
      if (!value) {
        return 'Required';
      }
    };
      ...
      _createClass(Form, [{
        ...
        value: function render() {
          return _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(Field, { name: 'username', component: usernameInput, validate: validateFn })
          );
        }
      }]);
